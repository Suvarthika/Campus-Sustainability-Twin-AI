...
class Database:
    ...
    def verify_session(self, session_token: str) -> Optional[Dict]:
        ...
        try:
            ...
            cursor.execute('''
                SELECT u.id, u.email, u.full_name, u.user_type, s.expires_at, u.phone, u.created_at
                FROM sessions s
            ...
            user_id, email, full_name, user_type, expires_at, phone, created_at = result
    ...
    def update_user_profile(self, user_id: int, email: str, phone: str) -> bool:
        """

...
async function showUserProfile() {
    try {
        ...
        if (data.success) {
            document.getElementById('profile-username').value = data.user.full_name || data.user.username || 'User';
            ...
            document.getElementById('profile-member-since').value = createdAt ? new Date(createdAt.toLocaleDateString ? createdAt : createdAt.replace(' ', 'T')).toLocaleDateString() : 'N/A';
